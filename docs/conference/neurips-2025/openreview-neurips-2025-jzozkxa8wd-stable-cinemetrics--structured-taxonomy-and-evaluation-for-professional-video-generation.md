...
title_zh: 稳定电影度量：面向专业视频生成的结构化分类与评估
...
score: 9.0
evidence: 为视频生成质量评估提供结构化评估框架
tldr: 该论文针对现有视频生成评估基准无法满足专业需求的问题，提出了稳定电影度量框架，通过建立包含场景、事件、光照和相机四个层次的76个细粒度控制节点，构建了专业视频生成评估基准，并开发了自动化提示分类与问题生成管线，实现了独立评估。
...
motivation: 现有视频生成评估基准未能捕捉专业影视制作的复杂性，缺乏结构化评估框架。
method: 提出稳定电影度量，定义场景、事件、光照、相机四个层次的76个控制节点，并构建专业提示基准和自动化评估管线。
result: 通过自动化管线实现专业视频生成质量的结构化评估，验证了框架的有效性。
conclusion: 稳定电影度量为专业视频生成提供了系统化的评估方法，推动生成质量提升。
---
